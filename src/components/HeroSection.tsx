  ...
  return (
    <section className="relative w-full min-h-screen overflow-x-hidden">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8">
        {/* ✅ center + badge down (header fixed இருந்தா இது perfect) */}
        <div className="min-h-screen flex flex-col items-center justify-center pt-20 sm:pt-0 text-center">
          {/* Welcome badge */}
          <motion.div
          ...
          <motion.div
            ...
            className="mt-14 sm:mt-20 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 w-full max-w-3xl"
          >
            {[
